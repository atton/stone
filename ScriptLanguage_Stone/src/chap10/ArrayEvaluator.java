...
@Reviser public class ArrayEvaluator {
	@Reviser public static class ArrayLiEx extends ArrayLiteral {
		public ArrayLiEx(List<ASTree> list) { super(list); }
	...
	@Reviser public static class AssignEx extends BasicEvaluator.BinaryEx {
		...
		@Override protected Object computeAssign(Environment env, Object rvalue) {
			ASTree le = left();
			if (le instanceof PrimaryExpr) {
				...
				if(p.hasPostfix(0) && p.postfix(0) instanceof ArrayRef) {
					...
					throw new StoneException("bad array acces", this);
				}
			}
